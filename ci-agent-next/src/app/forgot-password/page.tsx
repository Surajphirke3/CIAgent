                ...
                >
                    ...
                    {isSuccess && (
                        ...
                        >
                            ...
                            <p className="text-emerald-400 text-sm font-medium">If an account exists, a reset link has been sent to your email.</p>
                        </motion.div>
                    )}
                    ...
                    {!isSuccess ? (
                        ...
                        <div className="text-center">
                            <Link href="/login" className="inline-flex items-center gap-2 text-accent-cyan hover:text-white transition-colors font-semibold">
                    ...
                    {!isSuccess && (
                        <div className="text-center">
                            <Link href="/login" className="text-slate-500 text-sm hover:text-white transition-colors">
                                Remember your password? <span className="font-semibold text-accent-cyan ml-1">Log in</span>
                            </Link>
                        </div>
                    )}
                </motion.div>
