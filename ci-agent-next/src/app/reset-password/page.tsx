    ...
    if (isSuccess) {
        return (
            <motion.div
                ...
                className="w-full max-w-[440px] glass-card neon-border rounded-xl p-8 md:p-10 flex flex-col gap-8 text-center"
            >
                ...
                <Link
                    href="/login"
                    className="mt-4 w-full h-14 bg-gradient-to-r from-accent-cyan to-accent-purple hover:opacity-90 text-white font-bold rounded-lg shadow-[0_0_20px_rgba(6,182,212,0.4)] flex items-center justify-center gap-2 transition-all"
                >
                    Return to Login
    ...
    if (!token) {
        return (
            <motion.div
                ...
                animate={{ opacity: 1, y: 0, scale: 1 }}
                transition={{ duration: 0.7, delay: 0.2 }}
                className="w-full max-w-[440px] glass-card neon-border text-center rounded-xl p-8 md:p-10 flex flex-col gap-6 text-white"
            >
                ...
                <Link href="/forgot-password" className="text-accent-cyan hover:underline mt-4">
                    Request a new link
                </Link>
            </motion.div>
        );
